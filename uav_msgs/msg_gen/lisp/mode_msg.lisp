...
(cl:defmethod marker-val ((m <mode_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader uav_msgs-msg:marker-val is deprecated.  Use uav_msgs-msg:marker instead.")
  (marker m))
...
(cl:defmethod roslisp-msg-protocol:serialize ((msg <mode_msg>) ostream)
  ...
  (cl:let* ((signed (cl:slot-value msg 'marker)) (unsigned (cl:if (cl:< signed 0) (cl:+ signed 4294967296) signed)))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <mode_msg>) istream)
  "Deserializes a message object of type '<mode_msg>"
    (cl:let ((unsigned 0))
      ...
      (cl:setf (cl:slot-value msg 'marker) (cl:if (cl:< unsigned 2147483648) unsigned (cl:- unsigned 4294967296))))
    (cl:let ((unsigned 0))
      (cl:setf (cl:ldb (cl:byte 8 0) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 8) unsigned) (cl:read-byte istream))
      (cl:setf (cl:ldb (cl:byte 8 16) unsigned) (cl:read-byte istream))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<mode_msg>)))
  ...
  "d4076e03c4c3e3bb1339b01b12ca8e35")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'mode_msg)))
  "Returns md5sum for a message object of type 'mode_msg"
  "d4076e03c4c3e3bb1339b01b12ca8e35")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<mode_msg>)))
  ...
  (cl:format cl:nil "int32 marker~%int32 mode~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'mode_msg)))
  "Returns full string definition for message of type 'mode_msg"
  (cl:format cl:nil "int32 marker~%int32 mode~%~%~%"))
