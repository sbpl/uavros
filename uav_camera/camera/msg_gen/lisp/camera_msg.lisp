...
(cl:defmethod cl:initialize-instance :after ((m <camera_msg>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'camera_msg)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name camera-msg:<camera_msg> is deprecated: use camera-msg:camera_msg instead.")))

(cl:ensure-generic-function 'change_res-val :lambda-list '(m))
(cl:defmethod change_res-val ((m <camera_msg>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader camera-msg:change_res-val is deprecated.  Use camera-msg:change_res instead.")
  (change_res m))
